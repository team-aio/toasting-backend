...
enum class ErrorStatus(
    ...
    CUSTOM_COMPANY_EXPERIENCE_NOT_FOUND(HttpStatus.NOT_FOUND, "CUSTOM_COMPANY_EXPERIENCE_NOT_FOUND", "직접 입력한 경력을 찾을 수 없습니다."),
    UNAUTHORIZED_DELETE_COMPANY_EXPERIENCE(HttpStatus.BAD_REQUEST, "UNAUTHORIZED_DELETE_COMPANY_EXPERIENCE", "경력을 삭제할 권한이 없습니다."),
    UNAUTHORIZED_DELETE_CUSTOM_COMPANY_EXPERIENCE(HttpStatus.BAD_REQUEST, "UNAUTHORIZED_DELETE_CUSTOM_COMPANY_EXPERIENCE", "직접 입력한 경력을 삭제할 권한이 없습니다."),
    UNAUTHORIZED_UPDATE_COMPANY_EXPERIENCE(HttpStatus.BAD_REQUEST, "UNAUTHORIZED_UPDATE_COMPANY_EXPERIENCE", "경력을 수정할 권한이 없습니다."),
    UNAUTHORIZED_UPDATE_CUSTOM_COMPANY_EXPERIENCE(HttpStatus.BAD_REQUEST, "UNAUTHORIZED_UPDATE_CUSTOM_COMPANY_EXPERIENCE", "직접 입력한 경력을 삭제할 권한이 없습니다."),
    UNAUTHORIZED_UPDATE_COMPANY_EXPERIENCE_IS_VIEW(HttpStatus.BAD_REQUEST, "UNAUTHORIZED_UPDATE_COMPANY_EXPERIENCE_IS_VIEW", "숨기기 여부를 수정할 권한이 없습니다."),
    UNAUTHORIZED_UPDATE_CUSTOM_COMPANY_EXPERIENCE_IS_VIEW(HttpStatus.BAD_REQUEST, "UNAUTHORIZED_UPDATE_CUSTOM_COMPANY_EXPERIENCE_IS_VIEW", "숨기기 여부를 수정할 권한이 없습니다."),
    ;
